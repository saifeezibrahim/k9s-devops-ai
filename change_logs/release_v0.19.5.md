...
In this drop we've changed the configuration of the node shell action that lets you shell into nodes. Big 
...
* [PR #706](https://github.com/derailed/k9s/pull/706) Big 
...
* [PR #691](https://github.com/derailed/k9s/pull/691) Mega 
